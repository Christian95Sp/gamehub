...
View.prototype.drawPiecePositions = function (moves, moveInner) {
    ...
    // AGGIUNGI QUESTA RIGA (applica il colore solo al bordo della scacchiera):
    this.element.style.setProperty("--turn-color", "var(--color-".concat(this.game.turn.toLowerCase(), ")"));
